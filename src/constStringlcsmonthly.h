...
const string attrib_VIEW_STALIN = "VIEW_STALIN";
const string attrib_VIEW_MOOD = "VIEW_MOOD";
const string attrib_VIEW_GAY = "VIEW_GAY";
const string attrib_VIEW_DEATHPENALTY = "VIEW_DEATHPENALTY";
const string attrib_VIEW_TAXES = "VIEW_TAXES";
const string attrib_VIEW_NUCLEARPOWER = "VIEW_NUCLEARPOWER";
const string attrib_VIEW_ANIMALRESEARCH = "VIEW_ANIMALRESEARCH";
const string attrib_VIEW_POLICEBEHAVIOR = "VIEW_POLICEBEHAVIOR";
const string attrib_VIEW_TORTURE = "VIEW_TORTURE";
const string attrib_VIEW_INTELLIGENCE = "VIEW_INTELLIGENCE";
const string attrib_VIEW_FREESPEECH = "VIEW_FREESPEECH";
const string attrib_VIEW_GENETICS = "VIEW_GENETICS";
const string attrib_VIEW_JUSTICES = "VIEW_JUSTICES";
const string attrib_VIEW_GUNCONTROL = "VIEW_JUSTICES";
const string attrib_VIEW_SWEATSHOPS = "VIEW_SWEATSHOPS";
const string attrib_VIEW_POLLUTION = "VIEW_POLLUTION";
const string attrib_VIEW_CORPORATECULTURE = "VIEW_CORPORATECULTURE";
const string attrib_VIEW_CEOSALARY = "VIEW_CEOSALARY";
const string attrib_VIEW_WOMEN = "VIEW_WOMEN";
const string attrib_VIEW_CIVILRIGHTS = "VIEW_CIVILRIGHTS";
const string attrib_VIEW_DRUGS = "VIEW_DRUGS";
const string attrib_VIEW_IMMIGRATION = "VIEW_IMMIGRATION";
const string attrib_VIEW_MILITARY = "VIEW_MILITARY";
const string attrib_VIEW_PRISONS = "VIEW_PRISONS";
const string attrib_VIEW_AMRADIO = "VIEW_AMRADIO";
const string attrib_VIEW_CABLENEWS = "VIEW_CABLENEWS";
const string attrib_VIEW_LIBERALCRIMESQUAD = "VIEW_LIBERALCRIMESQUAD";

...
//const string CONST_news485 = ". ";
string squadstory_text_location(const Deprecatednewsstoryst ns, bool liberalguardian, bool ccs)
{
	string story;
	story += CONST_news106;
...
void displaystoryheader(const Deprecatednewsstoryst ns, const bool liberalguardian, int& y, int header)
{
	...
	case NEWSSTORY_PRESIDENT_IMPEACHED:
		...
		double_line_news = CONST_news745;
		break;
	case NEWSSTORY_PRESIDENT_BELIEVED_DEAD:
		single_line_news = getLastNameForHeadline(oldPresidentName);
		double_line_news = CONST_news746;
		break;
	case NEWSSTORY_PRESIDENT_FOUND_DEAD:
		single_line_news = getLastNameForHeadline(oldPresidentName);
		double_line_news = CONST_news747;
		break;
	case NEWSSTORY_PRESIDENT_FOUND:
		single_line_news = getLastNameForHeadline(oldPresidentName);
		double_line_news = CONST_news748;
		break;
	case NEWSSTORY_PRESIDENT_KIDNAPPED:
		single_line_news = getLastNameForHeadline(oldPresidentName);
		double_line_news = CONST_news1016;
		break;
	case NEWSSTORY_PRESIDENT_MISSING:
		single_line_news = getLastNameForHeadline(oldPresidentName);
		double_line_news = CONST_news750;
		break;
	case NEWSSTORY_PRESIDENT_ASSASSINATED:
		single_line_news = getLastNameForHeadline(oldPresidentName);
		double_line_news = CONST_news751;
		break;

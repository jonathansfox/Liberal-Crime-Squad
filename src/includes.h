...
const string CODENAME_SKILL_HEALTH_LOCATION_HEADER = "────CODE NAME────────────SKILL───HEALTH───LOCATION──────────────────────────────";
...
const string TYPE_DIFFICULTY_HEADER = "────TYPE─────────────────────────────────────────DIFFICULTY TO ARRANGE MEETING──";
...
const string LONG_LINE_BUT_NOT_EIGHTY = "──────────────────────────────────────────────────";
...
const string EIGHTY_LINE = "────────────────────────────────────────────────────────────────────────────────";
const string PRESS_A_LETTER_TO_SELECT_LIBERAL = "Press a Letter to select a Liberal";
const string NAME_HEALTH_HEART_HEADER = "────NAME───────────────────────HEALTH────────────HEART────────AGE───────────────";
...
const string NAME_DIFFICULTY_COST_HEADER = "────NAME─────────────────────────────DIFFICULTY─────────────COST────────────────";
...
const string CODE_NAME_CURRENT_ACTIVITY_HEADER = "────CODE NAME────────────CURRENT ACTIVITY───────────────────────────────────────";
...
const string CONST_activities056 = "XX% Issue ────────────────────────────────────────────────?Public Interest";
...
const string CONST_activities144 = "────TYPE────────────────────────────────────────DIFFICULTY TO FIND UNATTENDED──";
...
const string PLANNING_HEADER = "─── PLANNING ───";
const string ACTIVISM_HEADER = "─── ACTIVISM ───";
...
const string CONST_commondisplay005 = "────────────────────────────────────────────────────────────────────────────────";
const string SEVENTY_NINE_LINE = "─────────────────────────────────────────────────────┬─────────────────────────┬";
...
const string CODENAME_SKILL_WEAPON_ARMOR_HEALTH_HEADER = "#─CODE NAME────────────SKILL───WEAPON─────────ARMOR──────────HEALTH───TRANSPORT─";
...
#include "locations/locationsEnums.h"
	...
	const string CONST_ASSASSIN_SERIAL_KILLER_EITHER_WAY_GUILTY = "Assassin, serial killer, either way ── guilty. ";
	...
	const string CONST_UNIONS_WORKING_FOR_LIBERAL_ORGANIZATIONS_EVEN = "unions, working for liberal organizations ── even ";
	...
	const string CONST_COMING_TO_A_HALT_WITH_A_DEAFENING_CLANG_THAT_SAID_IT_ALL = "coming to a halt with a deafening clang that said it all ── ";

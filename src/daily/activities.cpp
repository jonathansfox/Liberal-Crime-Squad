...
void survey(Creature *cr)
{
	...
	mvaddstrAlt(7,  0, "XX% Issue ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ Public Interest");
	//Footer
	set_color_easy(WHITE_ON_BLACK);
...
bool carselect(Creature &cr, short &cartype)
{
	...
	while (true)
	{
		...
		set_color_easy(WHITE_ON_BLACK);
		mvaddstrAlt(1,  0, "ÄÄÄÄTYPEÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄDIFFICULTY TO FIND UNATTENDEDÄÄ");
		int y = 2, difficulty;

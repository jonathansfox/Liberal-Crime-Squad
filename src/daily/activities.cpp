...
void survey(Creature *cr)
{
	...
	moveAlt(7, 0);
	addstrAlt("XX% Issue ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ Public Interest");
	//Footer
	set_color(COLOR_WHITE, COLOR_BLACK, 0);
	moveAlt(23, 0);
...
bool carselect(Creature &cr, short &cartype)
{
	...
	while (true)
	{
		...
		set_color(COLOR_WHITE, COLOR_BLACK, 0);
		moveOneZero();
		addstrAlt("ÄÄÄÄTYPEÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄDIFFICULTY TO FIND UNATTENDEDÄÄ");
		int y = 2, difficulty;
